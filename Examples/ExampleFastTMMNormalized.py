...
def get_parameters():
    ...
    batch_size = 1
    wavelength = WaveLength(ranges=[150,600], steps=0.005, units="nm", unit_prefix=None)
    layer_1_thickness = 22.73   # nm 
    layer_2_thickness = 54.13   # nm
    layer_defect_thickness = 51.31 
    parameters = {
...
if __name__ == "__main__":
    ...
    wavelength_nm = parameters['wavelength'].values.squeeze()
