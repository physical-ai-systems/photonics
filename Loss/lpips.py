...
This file may have been modified by
Bytedance Ltd. and/or its affiliates (“Bytedance's Modifications”).
...
class LPIPS(nn.Module):
    ...
    def load_pretrained(self):
        # Correctly locate the pretrained model directory relative to this file.
        # This assumes the script is in loss/ and models are in models/ at the project root.
        root_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'models'))
        ckpt_dir = os.path.join(root_dir, "vgg_lpips")
        VGG_PATH = get_ckpt_path("vgg_lpips", ckpt_dir, check=True)
